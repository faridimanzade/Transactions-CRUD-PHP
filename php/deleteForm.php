...
<body>
    ...
    <form class="form" method="POST" action="deleteDatabase.php?myID=<?php echo "$deleteID"?>">

        <p id="heading">Delete Transaction</p>

        <?php 
            echo "<input class='text' type='number' name='amount' placeholder='Transaction Amount' min='0' required disabled value='$transactionAmount'>";
        ?>


        <select name='category' required="required" disabled="disabled">
                <?php
        ...
        <select name='method' required="required" disabled="disabled">
            <?php
        ...
        <?php 
            echo "<input type='date' class='text' name='date' required='required'disabled='disabled' value='$transactionDate'>";
        ?>

        
        <button class="login" name="delete">Delete</button>
